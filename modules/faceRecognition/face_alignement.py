...
def main(args):
    ...
    for img_path, label in dataset.samples:
        if 'timestamp' not in img_path:
            ...
            new_path = os.path.join(args.output_dir, dataset.classes[label], img_class_path_name)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--input_dir', type=str, help='Directory with unaligned images.',
                        default= "/home/icub/PycharmProjects/SpeakerRecognitionYarp/data/unknown")
    parser.add_argument('--output_dir', type=str, help='Directory with aligned face thumbnails.',
                        default= "/home/icub/PycharmProjects/SpeakerRecognitionYarp/data/unknown_aligned")
